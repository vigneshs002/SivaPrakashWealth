      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-3">
            Articles we are publishing next
          </h2>
          ...
          {posts.map((p, i) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <Link href={p.href} className="block text-lg font-semibold text-gray-900 hover:text-primary transition-colors mb-2 leading-snug">
                  {p.title}
                </Link>
                <p className="text-gray-500 text-sm leading-relaxed mb-4">{p.excerpt}</p>
                <Link href={p.href} className="text-primary text-sm font-medium hover:underline flex items-center gap-1">
                  View blog →
                </Link>
              </div>
            </motion.div>
